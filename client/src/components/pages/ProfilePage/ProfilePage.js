    ...
    <>
      <Container>
        <div className="profile-container">
          ...
          <Row className="back-button">
            <Button className="btn-create-fit button-profile-back" onClick={outDetailsClick}>
              Volver
            </Button>
          </Row>
          {userDetails.role === "PROFESOR" && id !== loggedUser._id ? (
            <>
              ...
              <Row>
                {showForm && (
                  <NewReviewForm show={showForm} closeForm={closeForm} teacherId={id} refreshReviews={refreshReviews} />
                )}
              </Row>
            </>
          ) : null}
